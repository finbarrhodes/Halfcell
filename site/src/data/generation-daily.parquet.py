"""Daily generation by fuel group (already pre-aggregated upstream)."""
import io
import sys
...
out = (
    pd.read_parquet(ROOT / "data/processed/generation_daily.parquet")
    .rename(columns={"settlementDate": "date", "fuelGroup": "fuel_group"})
    .sort_values(["date", "fuel_group"])
