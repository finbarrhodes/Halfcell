"""Monthly GB BESS fleet capacity from DESNZ REPD.

is_extrapolated marks months projected past the end of the quarterly extract —
carried through so charts can render those months distinctly.
"""
import io
import sys
...
out = pd.read_parquet(ROOT / "data/processed/bess_fleet_capacity.parquet")
